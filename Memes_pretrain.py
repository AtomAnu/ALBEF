...
def main(args, config):
    ...
    datasets = [create_dataset('memes_pretrain', config)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./configs/Memes_pretrain.yaml')
    parser.add_argument('--checkpoint', default='') 
    parser.add_argument('--resume', default=False, type=bool)
    parser.add_argument('--output_dir', default='output/memes_pretrain/')
